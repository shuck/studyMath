...
def generate_math_problems(num_problems=10):
    ...
    for _ in range(num_problems):
        ...
        if operation == '+':  # 加法
            ...
            multiplicand = random.randint(1, 9)  # 限制乘积不超过100
...
def create_math_pdf(problems, filename="Math_Problems.pdf"):
    ...
    # 设置PDF字体
    pdf.add_font("NotoSansSC", "", "D://kousuan//NotoSansSC-6.ttf", uni=True)
    pdf.add_font("NotoSansSC", "B", "D://kousuan//Noto-Sans-SC-Bold-2.ttf", uni=True)
